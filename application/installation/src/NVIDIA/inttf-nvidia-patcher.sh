...
function usage {
  ...
  echo "script usage: $(basename $0) [-h] [-v 340.108, 418.113 or 435.21]" >&2
}
...
nvidia_versions=( '340.108' '418.113' '435.21' )
...
case "${nvidia_short_ver}" in
  340)
    ...
    patch_file_b2sums=( 
      ...
      '87b7133da3866fa6e98c77f7c6d7adf1f7808b2015f72038caddf545d44f3a7a5be8dd82c1680d736fdcb0a04e7ff5b71282785a241cfa839c49113fe945e1f4')
    ;;
#  390)
#    patch_file_names=( 
#      'kernel-4.16.patch' 
...
./$nvidia_directory/makeself.sh --target-os Linux --target-arch x86_64 $nvidia_directory $nvidia_directory-patched-kernel-5.10.run "NVIDIA driver $nvidia_version patched for kernel 5.10+" ./nvidia-installer
